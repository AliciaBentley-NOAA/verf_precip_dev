...
do
  for model in nam namx namb \
	       	...
	       	conusfv3 conusarw conusarw2 firewxcs \
		cmc cmcglb dwd ecmwf jma metfr ukmo medley \
		srmean srfreqm \
		ndas ndassoil
  do
...
cp /lfs/h1/ops/prod/com/pcpanl/v4.1/pcpanl.$vday/st4_conus.${vday}12.24h.gif ./st4.${vday}12.24h.gif
